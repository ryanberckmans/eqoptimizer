...
constraintsOk constraints items =
  and (map (\(constraint, attribute) -> (constraint constraints) <= sum (map attribute items))
...
main = do
  ...
  lightEq <- readFile "/Users/ryanandlyndsey/Dropbox/medievia/EqOpti/lightEq.txt"
  fingerOneEq <- readFile "/Users/ryanandlyndsey/Dropbox/medievia/EqOpti/fingerOneEq.txt"
  bodyEq <- readFile "/Users/ryanandlyndsey/Dropbox/medievia/EqOpti/bodyEq.txt"
  headEq <- readFile "/Users/ryanandlyndsey/Dropbox/medievia/EqOpti/headEq.txt"
  legsEq <- readFile "/Users/ryanandlyndsey/Dropbox/medievia/EqOpti/legsEq.txt"
  feetEq <- readFile "/Users/ryanandlyndsey/Dropbox/medievia/EqOpti/feetEq.txt"
  handsEq <- readFile "/Users/ryanandlyndsey/Dropbox/medievia/EqOpti/handsEq.txt"
  armsEq <- readFile "/Users/ryanandlyndsey/Dropbox/medievia/EqOpti/armsEq.txt"
  shieldEq <- readFile "/Users/ryanandlyndsey/Dropbox/medievia/EqOpti/shieldEq.txt"
  aboutEq <- readFile "/Users/ryanandlyndsey/Dropbox/medievia/EqOpti/aboutEq.txt"
  waistEq <- readFile "/Users/ryanandlyndsey/Dropbox/medievia/EqOpti/waistEq.txt"
  wristOneEq <- readFile "/Users/ryanandlyndsey/Dropbox/medievia/EqOpti/wristOneEq.txt"
  wieldEq <- readFile "/Users/ryanandlyndsey/Dropbox/medievia/EqOpti/wieldEq.txt"
  heldEq <- readFile "/Users/ryanandlyndsey/Dropbox/medievia/EqOpti/heldEq.txt"
  let all_eq = [(Light, parseEqFile (lines lightEq)), (Finger, parseEqFile (lines fingerOneEq)), (Finger, parseEqFile (lines fingerOneEq)), (Body, parseEqFile (lines bodyEq)), (Head, parseEqFile (lines headEq)), (Legs, parseEqFile (lines legsEq)), (Feet, parseEqFile (lines feetEq)), (Hands, parseEqFile (lines handsEq)), (Arms, parseEqFile (lines armsEq)), (Shield, parseEqFile (lines shieldEq)), (About, parseEqFile (lines aboutEq)), (Waist, parseEqFile (lines waistEq)), (Wrist, parseEqFile (lines wristOneEq)), (Wrist, parseEqFile (lines wristOneEq)), (Wield, parseEqFile (lines wieldEq)), (Held, parseEqFile (lines heldEq))]
